...
vlog -sv +incdir+. \
    ...
    tb/tb_conv5x5_pe.sv \
    tb/tb_requantize.sv \
    tb/tb_conv5x5_row_mac.sv \
    tb/tb_dense_row_mac.sv \
    tb/tb_conv5x5_pe_stream.sv \
...
vsim -c work.tb_conv5x5_row_mac
onfinish stop
run -all
quit -sim

vsim -c work.tb_dense_row_mac
onfinish stop
run -all
quit -sim

vsim -c work.tb_conv5x5_pe_stream
onfinish stop
run -all
quit -sim
